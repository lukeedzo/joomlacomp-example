 ...
 * @since  1.0.0
 */
class ExampleitemModel extends AdminModel
{
    /**
     ...
     * @since  1.0.0
     */
    public $typeAlias = 'com_example.exampleitem';
        ...
        foreach ($pks as $pk) {
            ...
            if ($table->load($pk, true)) {
                ...
                if (!empty($table->category)) {
                    if (is_array($table->category)) {
                        $table->category = implode(',', $table->category);
                    }
                } else {
                    $table->category = '';
                }
