...
class CategoryModel extends AdminModel
{
     ...
     * @since  1.0.0
     */
    public $typeAlias = 'com_example.category';
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState('com_example.edit.category.data', array());
    ...
    protected function prepareTable($table)
    {
        ...
        if (empty($table->id)) {
            ...
            if (@$table->ordering === '') {
                $db = $this->getDbo();
                $db->setQuery('SELECT MAX(ordering) FROM #__example_categories');
                $max = $db->loadResult();
